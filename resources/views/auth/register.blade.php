            ...
            <div class="relative z-10 flex flex-col justify-between w-full">
                ...
                <div>
                    ...
                    <p class="text-lg text-emerald-100 max-w-xl">
                        Buat akun CashTrack dan pantau pemasukan, pengeluaran, aset, serta laporan keuanganmu.
                    </p>
                    ...
                    <div class="grid grid-cols-3 gap-4 mt-10 max-w-xl">
                        <div class="bg-white/10 rounded-2xl p-4 backdrop-blur">
                            ...
                            <p class="text-sm text-emerald-100">Buat akun</p>
                        </div>

                        <div class="bg-white/10 rounded-2xl p-4 backdrop-blur">
                            <p class="text-3xl font-bold">02</p>
                            <p class="text-sm text-emerald-100">Tambah saldo</p>
                        </div>

                        <div class="bg-white/10 rounded-2xl p-4 backdrop-blur">
                            <p class="text-3xl font-bold">03</p>
                            <p class="text-sm text-emerald-100">Catat transaksi</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-3xl shadow-xl border border-slate-100 p-8">
                    <div class="mb-8">
                        ...
                        <p class="text-slate-500 mt-2">
                            Daftar untuk mulai menggunakan CashTrack.
                        </p>
                    </div>
